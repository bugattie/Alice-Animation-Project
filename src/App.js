  ...
  return (
    <>
      <div className="wrapper">
        <div id="ending-ui">
          <div className="ending-ui_wrapper">
            <div id="ending-ui_panels">
              <div id="learn-more" className="ending-ui_back">
                <h1>
                  <img
                    src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice-in-waapi-land_logo_small.png"
                    srcSet="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice-in-waapi-land_logo.png 2x"
                    alt="Alice in Web Animation API Land"
                  />
                </h1>
                ...
                <p>
                  A continuation of{" "}
                  <a
                    href="http://rachelnabors.com/alice-in-videoland/book/"
                    target="_blank"
                  >
                    Alice in Videoland
                  </a>
                  . Created by{" "}
                  <a href="http://rachelnabors.com" target="_blank">
                    Rachel Nabors
                  </a>
                  .
                </p>
                <a
                  href="http://rachelnabors.com"
                  target="_blank"
                  className="author"
                >
                  <img
                    src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/rachel-nabors_small.jpg"
                    srcSet="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/rachel-nabors.jpg 2x"
                    alt="Rachel Nabors was here."
                  />
                </a>
                <div className="what-now">
                  <img
                    ...
                    alt="Play again?"
                    src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/text_play-again.svg"
                  />
                </div>
              </div>
              <div id="ui_poor-alice" className="ending-ui_front">
                <h2>
                  <img
                    src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/text_poor-alice.svg"
                    alt="Poor Alice&hellip;"
                    className="text_poor-alice"
                  />
                </h2>
                <div className="what-now">
                  <img
                  ...
                  />
                  <a
                    id="learn-more_button"
                    className="button"
                    href="#learn-more"
                  >
                    <img
                      src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/text_learn-more.svg"
                      alt="Learn more"
                    />
                  </a>
                </div>
                <img
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/hr.svg"
                  alt=" "
                  className="hr"
                />
              </div>
        ...
        <div id="alice">
          <svg
            className="alice_lines"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 195.6 729.3"
          >
            <defs>
              {/* <style>
              .cls-1{fill:#441238}.cls-2{fill:#fff;}
              </style> */}
            </defs>
            <g>
              <image
        ...
        <div className="table-set">
          <img
            className="table"
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/table.png"
          />
          <div className="drink-me">
            <img
              className="doily"
              src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/doily_small.png"
              srcSet="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/doily.png 2x"
            />
            <div id="bottle">
              <div id="liquid"></div>
              <img
          ...
          <div id="eat-me">
            <img
              id="eat-me_sprite"
              src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/sprite_cupcake_small.png"
              srcSet="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/sprite_cupcake.png 2x"
              alt="A cake labeled Eat Me"
            />
          </div>
        </div>
        <div id="endings">
          <div className="ending" id="end-in-tears">
            <div className="alice_breakdown">
              <img
                id="pool"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/pool.svg"
              />

              <img
                className="tear"
                id="tear1"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear1.svg"
              />
              <img
                className="tear"
                id="tear2"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear2.svg"
              />
              <img
                className="tear"
                id="tear3"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear3.svg"
              />
              <img
                className="tear"
                id="tear4"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear4.svg"
              />
              <img
                className="tear"
                id="tear5"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear5.svg"
              />
              <img
                className="tear"
                id="tear6"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/tear6.svg"
              />

              <img
                className="alice_crying"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice_crying.svg"
              />
            </div>
          </div>
          <div className="ending" id="end-too-small">
            <div className="too-small_wrapper">
              <div id="alice_too-small">
                <img
                  id="alice_arm"
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice_small_arm.svg"
                />
                <img
                  className="alice_small"
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice_small.svg"
                />
                <img
                  id="exclaim"
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/alice_exclaimation.svg"
                />
              </div>

              <img
                className="door"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/door.svg"
              />

              <img
                className="table-with-key"
                src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/table-with-key.svg"
              />
            </div>
          </div>
